...
export default function Account() {
  ...
  async function pickAvatar() {
    ...
    if ('error' in up) return setMsg(up.error);
    await supabase.auth.updateUser({ data: { avatar_url: up.url, custom_avatar_url: up.url, avatar_choice: 'custom' } });
  ...
  return (
    <ScreenContainer>
      ...
      <ThemedButton variant="destructive" label="Sign out" onPress={logout} style={{ marginTop: Spacing.xl, marginBottom: Spacing.md }} />
    </ScreenContainer>
  );
}
